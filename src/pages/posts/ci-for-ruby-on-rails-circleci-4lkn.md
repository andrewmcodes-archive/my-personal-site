...
excerpt: >-
  ...
  part series wher...
thumb_img_path: >-
  https://res.cloudinary.com/practicaldev/image/fetch/s--bA6XKXuJ--/c_imagga_scale,f_auto,fl_progressive,h_420,q_auto,w_1000/https://res.cloudinary.com/practicaldev/image/fetch/s--bmKbiFc4--/c_imagga_scale%2Cf_auto%2Cfl_progressive%2Ch_420%2Cq_auto%2Cw_1000/https://thepracticaldev.s3.amazonaws.com/i/b4knmzfjstqjy1ph89dk.jpg
comments_count: 0
...
This tells our job that we want to run the commands we will define later inside of a container built with the 
...
- run:
    ...
    command: find app/javascript -type f -exec md5 -q {} \; > dependency_checksum
- restore_cache:
